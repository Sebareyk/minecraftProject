    ...
    public:
        ...
        Player() {
            ...
            */
            ...
            StateButton enchantingStateButton{"enchanting", HORZ_ALIGN + (4 * DISTANCE_BETWEEN_BUTTONS), VERT_ALIGN};
            ...
            this->buttons.push_back(enchantingStateButton);
        }
