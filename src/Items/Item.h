...
class Item {
    private:
        ...
        string enchantments; ///<<< NEW This one holds all the enchantments that the Item wields.
    public:
        /**
         ...
         * New @param iEnch Idicates whether/not an item is enchantable.
         */
        Item(int iN, int mS, int fL, ofImage spr, string iNa, string ench = "none") {
            this->itemNumber = iN;
            this->maxStack = mS;
            this->fuelLevel = fL;
            this->sprite = spr;
        ...
        string getName() { return this->name; }
         ...
         /**
         * @brief Gets the enchantments of the tool.
         * @return Tool Enchantments, default to "none".
         */
        string getEnchantments() { return this->enchantments; }
        ...
        /**
         * @brief Updates the Enchantments string.
         */
        void setEnchantments(string newEnchantments){
