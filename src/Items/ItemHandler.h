...
class ItemHandler {
    ...
    public:
        ...
        ItemHandler() {
            ...
            // Ender Weapons 
            itemList.push_back(Item(57, 1, 0, getSpriteFromSheet(3, 22), "Ender Pickaxe"));
            itemList.push_back(Item(58, 1, 0, getSpriteFromSheet(6, 22), "Ender Shovel"));
            itemList.push_back(Item(59, 1, 0, getSpriteFromSheet(4, 22), "Ender Sword"));
            itemList.push_back(Item(60, 1, 0, getSpriteFromSheet(5, 22), "Ender Axe"));
            itemList.push_back(Item(61, 1, 0, getSpriteFromSheet(7, 22), "Ender Hoe"));

            // BONUS!! Enchanting Items :)
            itemList.push_back(Item(62, 64, 1, getSpriteFromSheet(13, 13), "Paper"));
            itemList.push_back(Item(63, 64, 0, getSpriteFromSheet(12, 15), "Leather"));
            itemList.push_back(Item(64, 64, 2, getSpriteFromSheet(14, 13), "Book"));
            itemList.push_back(Item(65, 1, 0, getSpriteFromSheet(13, 6), "Enchantment Table"));
            itemList.push_back(Item(66, 64, 0, getSpriteFromSheet(5, 17), "Lapis Lazuli"));
            itemList.push_back(Item(67, 1, 0, getSpriteFromSheet(0, 20), "Enchanted Book"));
            itemList.push_back(Item(68, 64, 0, getSpriteFromSheet(5, 12), "Sugar Cane"));
        }
};